package com.audacioustux.braindrop.security.oauth2;
...
import com.audacioustux.braindrop.security.oauth2.user.OAuth2UserInfo;
import com.audacioustux.braindrop.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setProviderUsername(oAuth2UserInfo.getUsername());
